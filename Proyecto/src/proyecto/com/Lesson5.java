...
public class Lesson5 extends Activity{
    ...
    public void iniciar(View v) {
        ...
        if (boton2.isPressed()) {
        	mp = MediaPlayer.create(this, R.raw.sonido18);
		}
        if (boton3.isPressed()) {
        	mp = MediaPlayer.create(this, R.raw.sonido17);
		}
        ...
        if (boton6.isPressed()) {
        	mp = MediaPlayer.create(this, R.raw.sonido20);
		}
        if (boton7.isPressed()) {
        	mp = MediaPlayer.create(this, R.raw.sonido22);
		}
        if (boton8.isPressed()) {
        	mp = MediaPlayer.create(this, R.raw.sonido21);
		}
        if (boton9.isPressed()) {
        	mp = MediaPlayer.create(this, R.raw.sonido23);
		}
    ...
    public void irSiguiente(View v){
	    Intent i = new Intent(this, Lesson6.class);
